...
export default function How() {
  return (
    <div id="how-it-works" className="h-auto lg:h-[1074px] w-screen flex flex-col relative overflow-hidden pt-20 gap-[72px]">
      ...
      <div className="h-auto lg:h-[767px] w-full  2xl:px-[120px] xl:px-20 px-10 flex items-start relative overflow-y-scroll">
        <div className="h-auto w-full  flex flex-col gap-4 lg:gap-[150px] pb-[72px] lg:pb-[354px] xl:pb-[278px]">
