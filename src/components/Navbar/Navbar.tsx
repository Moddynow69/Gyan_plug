...
export default function Navbar() {
  return (
    <div className="w-[1000px] xl:w-[1200px] 2xl:w-[1488px] h-[98px] 2xl:px-8 xl:px-4 px-2 py-4 rounded-2xl border-[0.5px] border-[#E8E8E899] backdrop-blur-[44px] justify-between items-center inline-flex bg-[#FFFFFFCC] shadow-[0px_12px_48px_0px_#0067690D]">
