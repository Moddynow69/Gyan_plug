...
export default function FaqItem({ heading, paragraph }: Props) {
  ...
  return (
    <div
      className={`flex flex-col w-[100%] gap-[1.5rem] justify-between duration-700 ${
        isVisible ? "h-[9.2rem]" : ""
      }`}
    >
      <div
      ...
      <hr className="border-[rgba(20,164,225,0.20)] border-[1px] w-[100%] transition-all ease duration-700" />
    </div>
  );
}
