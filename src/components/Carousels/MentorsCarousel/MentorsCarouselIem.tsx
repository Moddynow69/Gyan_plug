...
export default function MentorsCarouselTItem({
  ...
  return (
    <div className="w-[216px] md:w-[448px] h-[283.92px] md:h-[545px] bg-gradient-to-b from-[#B3E4FACC] to-[#B3E4FA66] p-[1.6px] rounded-[12px] md:rounded-3xl shadow-[0px_11.52px_24.96px_0px_#04719F1A,0px_45.44px_45.44px_0px_#04719F17,0px_101.76px_60.8px_0px_#04719F0D,0px_181.12px_72.32px_0px_#04719F03,0px_282.24px_79.36px_0px_#04719F00] relative overflow-y-visible">
      ...
      <div className="h-full w-full bg-[#FDFDFD] rounded-[12px] md:rounded-3xl flex flex-col items-center justify-center gap-6 p-3">
        <Image
          src={story.image}
          alt={story.name}
          height={320}
          width={400}
          className="w-[193.65px] md:w-[400px] h-[154.92px] md:h-[320px] rounded-[8px] md:rounded-2xl"
        />
