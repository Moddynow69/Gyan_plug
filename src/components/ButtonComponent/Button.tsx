...
export default function ButtonComponent({ type, content }: Props) {
  if (type === "primary") {
    return (
      <div className="flex w-[579px] px-[64px] py-[24px] justify-center items-center gap-[8px] rounded-[12px] bg-[#14A4E1]">
    ...
    return (
      <div>
        <div className="flex w-[320px] pt-[20px] pb-[20px] pl-[24px] pr-[24px] justify-center items-center gap-[4px] text-xl rounded-[6px] bg-[#14A4E1] font-folito font-bold">
          {content}
