export const FaqItems: { heading: string; paragraph: string }[] = [
  ...
  },
  {
    ...
    paragraph:
      "Admission Counselors having a minimum of 3+ years of experience are eligible to apply. Shortlisted applicants will be invited to the selection process. If selected, your profile will get listed on the platform free of cost.",
  },
  {
    heading: "How will it benefit me?",
    paragraph:
      "If selected, your profile will be marketed free of cost on the Gyanplug platform. Students opting for your profile will be directly connected with you for the counseling via Zoom meeting/chat/call. You can counsel them for any institution based on student needs.",
  },
  {
